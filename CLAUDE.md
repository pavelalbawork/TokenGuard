...
macOS menu bar app (Swift 6.0, macOS 14+) that shows AI service usage limits and reset timers at a glance. Supports multiple accounts across Claude, Codex, Gemini, and Antigravity. Zero third-party dependencies — Apple frameworks only.
